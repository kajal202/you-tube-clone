...
import { AiFillDislike, AiFillLike, AiOutlineBell, AiOutlineDislike, AiOutlineLike } from "react-icons/ai"
    ...
    <div className="btns_cont_videoPage">
      ...
      <div className="btn_VideoPage">
        ...
        <div className="like_videoPage" onClick={(e) => togglelikevideo(e, vv?.Like)}>
          ...
          {/* <div className="subscribe" onClick={(e) => toggledislikevideo(e, vv?.subscibe)}>
            {Subscribebtn ? (
              <>
                <AiOutlineBell size={22} className='btns_videoPage' />
                <b>Subscribed</b>
              </>
            ) : (
              <>
             ...
             <IoIosArrowDown size={22} className='btns_videoPage' />
          </div> */}

          <div className="like_dislike_subscibe" onClick={(e) => toggledislikevideo(e, vv?.Like)}>
            {likebtn ? (
              <>
